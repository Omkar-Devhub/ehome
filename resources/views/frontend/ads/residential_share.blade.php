...
@section('content')
    <div class="container py-5" style="min-height: 600px;">
        <div style="margin: 0 auto;max-width: 600px;">
            ...
            @endif
            <div>
                <form id="multiStepForm" action="{{ route('user.residential.share.ads.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="step" id="step2">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col">
                                    <label class="form-label" for="single_bedrooms">Beds</label>
                                ...
                                <div class="col">
                                    ...
                                    <select class="shadow-none form-select" name="preference" id="preference" required>
