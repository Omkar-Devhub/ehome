...
@section('content')
    <div class="container py-5" style="min-height: 600px;">
        <div style="margin: 0 auto;max-width: 600px;">
            ...
            @endif
            <div>
                <form id="multiStepForm" action="{{ route('user.commercial.sale.ads.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                @if ($property_types->count() > 0)
                                    <div class="col">
                                        ...
                                        <select
                                            class="shadow-none form-select @error('property_type') is-invalid  @enderror"
                                            name="property_type" id="property_type" required>
                                            <option value="">Select Property Type</option>
                                            @foreach ($property_types as $property_type)
                                                <option value="{{ $property_type->id }}">
                                                    {{ Str::title($property_type->name) }}
                                                </option>
                                            @endforeach
                                        </select>
                                        @error('property_type')
                        ...
                        <div class="mb-4">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <select class="shadow-none form-select @error('units') is-invalid  @enderror"
                                        id="units" name="units">
