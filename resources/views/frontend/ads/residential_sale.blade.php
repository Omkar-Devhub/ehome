...
@section('content')
    <div class="container py-5" style="min-height: 600px;">
        <div style="margin: 0 auto;max-width: 600px;">
            ...
            @endif
            <div>
                <form id="multiStepForm" action="{{ route('user.residential.sale.ads.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="step" id="step2">
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col">
                                    <label class="form-label" for="selling_type">Selling Type</label>
                                    <select
                                        class="shadow-none form-select @error('selling_type')
                                        is-invalid
                                    @enderror"
                                        id="selling_type" name="selling_type" required>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col">
                                    <label class="form-label" for="tax_designation">Tax Designation (Optional)</label>
                                    <select class="shadow-none form-select" name="tax_designation" id="tax_designation">
                                        <option value="Not Applicable">Not Applicable</option>
                                        <option value="Section 23">Section 23</option>
                                        <option value="Section 27">Section 27</option>
                                        <option value="Section 48">Section 48</option>
                                        <option value="Section 50">Section 50</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3">
                            <div class="row">
                                ...
                                <div class="col">
                                    <label class="form-label" for="twin_bedrooms">Twin Bedrooms</label>
