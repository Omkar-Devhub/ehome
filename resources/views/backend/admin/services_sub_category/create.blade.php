    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid my-2">
                <div class="d-flex justify-content-between">
                    <h1>Create Services Sub Category</h1>
                    <a href="{{ route('admin.services-sub-category') }}" class="btn btn-dark">Back</a>
                </div>
            </div>
            <!-- /.container-fluid -->
        </section>
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card">
                    <form action="{{ route('admin.services-sub-category.store') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="service_category_id" id="category"
