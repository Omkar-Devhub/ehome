    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <form action="{{ route('admin.blogs-posts.update', $blog->id) }}" method="POST"
                                        ...
                                        <div class="col-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="slug" id="slug"
                                                    ...
                                                    placeholder="Slug" value="{{ old('slug', $blog->slug) }}" readonly>
                                                @error('slug')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="content" id="content" class="summernote @error('content') is-invalid @enderror" cols="30"
                                                    rows="25">{{ old('content', $blog->content) }}</textarea>
                                                @error('content')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                <div class="custom-control custom-switch">
                                                    <input type="checkbox" class="custom-control-input" id="status"
                                                        name="status" {{ $blog->is_active == 1 ? 'checked' : '' }}>
