                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" id="title"
                                            ...
                                            value="{{ old('title', $page->title) }}" placeholder="Name">
                                        @error('title')
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <select name="menu_name" id="menu_name" class="form-control">
                                                <option value="eirehome"
                                                    {{ $page->menu_name == 'eirehome' ? 'selected' : '' }}>Eirehome
                                                </option>
                                                <option value="legal" {{ $page->menu_name == 'legal' ? 'selected' : '' }}>
                                                    Legal
                                                </option>
                                            </select>
                                        </div>
