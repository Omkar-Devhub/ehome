    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card">
                    <form action="{{ route('admin.settings.maintenance-section.update') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea
                                            class="form-control @error('message')
                                                is-invalid
                                            @enderror"
                                            id="message" name="message" rows="3">{{ $maintenance->message }}</textarea>
                                        @error('message')
                                    ...
                                    <div class="mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="status"
                                                name="status" {{ $maintenance->status == 1 ? 'checked' : '' }}>
                                            <label class="custom-control-label text-danger" for="status">Maintenance
                                                Status</label>
                                        </div>
                                    </div>
                                </div>
