    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="container-fluid">
                <div class="card">
                    <form action="{{ route('admin.settings.feature-property-section.update') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="title" id="title" value="{{ $featured->title }}"
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="heading" id="heading" value="{{ $featured->heading }}"
                                ...
                                <div class="col-12 col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="btn_link" id="btn_link"
                                            value="{{ $featured->button_link }}"
                                            class="form-control @error('btn_link')
                                                is-invalid
                                            @enderror"
                                    ...
                                    <div class="mb-3">
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" class="custom-control-input" id="status"
                                                name="status" {{ $featured->status == 1 ? 'checked' : '' }}>
