...
class SaleAdsController extends Controller
{
    public function residentialSaleAds()
    {
        ...
        return view('frontend.ads.residential_sale', compact('counties', 'bers', 'facilities', 'property_types'));
    }

    public function residentialSaleAdsStore(Request $request)
    {
        ...
        $property_id = Property::insertGetId([
            ...
            'tax_designation' => $request->tax_designation,
