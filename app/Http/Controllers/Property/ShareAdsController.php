...
class ShareAdsController extends Controller
{
    public function residentialShareAds()
    {
        ...
        $property_types = PropertyType::where('property_category_id', '3')->latest()->get();
        return view('frontend.ads.residential_share', compact('counties', 'bers', 'facilities', 'property_types'));
    }

    public function residentialShareAdsStore(Request $request)
    {
