...
class CommercialSaleAdsController extends Controller
{
    public function commercialSaleAds()
    {
        ...
        return view('frontend.ads.commercial_sale', compact('counties', 'bers', 'facilities', 'property_types'));
    }

    public function commercialSaleAdsStore(Request $request)
    {
